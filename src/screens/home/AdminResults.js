...
import {  fetchAdminSearchResults, fetchSearchResults,  imgUrl } from '../../api/PropertyDb';
...
const AdminResults = () => {
  ...
  const {idProperty, type , prix ,surface , quartier } = route.params;
...
const handleSearch = async() =>{
  ...
  await fetchAdminSearchResults(Data)
