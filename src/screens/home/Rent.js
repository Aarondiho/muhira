...
<View>
             ...
             <Text className="text-black text-3xl font-bold text-center mb-3" style={{marginTop:20,padding:3}}>A louer</Text>
      ...
      <ImageBackground source={ICONS.backgdi} resizeMode="cover" >
            ...
            {loading?(
              ...
              <Waiting data={datas}/>
                ...
                data={houses} page={ROUTES.DETAIL} backgd="" types="1" zone="" action="1"/>
              )}
            ...
            <RentList 
              title={
                ...
                lang=='en'?"Plot":''
                 ...
                 data={lands} page={ROUTES.DETAIL} backgd="" types="2" action="1"/>
          ...
          <Text style={{width:200, ...styles.text}} className=" font-bold mx-6 mt-3 mb-3 text-center bg-neutral-200 rounded-xl" >
           ...
           {loading?(
            ...
            <Waiting data={datas}/>
             ...
             data={apparts} page={ROUTES.DETAIL}  backgd="" types="3" action="1"/>
